**Path**: [ATM Strategy Methods](./atm_strategy_methods.md) > [BarsSinceEntryExecution()](./barssinceentryexecution.md)

# BarsSinceEntryExecution()

# BarsSinceEntryExecution()

## [Definition](./barssinceentryexecution.md)
...
## [Parameters](./barssinceentryexecution.md)
...
The index of the Bars object the entry order was submitted against. Note: See the [BarsInProgress](./barsinprogress.md) property.

entryExecutionsAgo

Number of entry executions ago. Pass in 0 for the number of bars since the last entry execution.

## [Examples](./barssinceentryexecution.md)
