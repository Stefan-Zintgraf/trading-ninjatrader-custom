**Path**: [System Indicator Methods](./system_indicator_methods.md) > [Moving Average - Triple Exponential (TRIX)](./moving_average_triple_exponential_trix.md)

# Moving Average - Triple Exponential (TRIX)

# Moving Average \- Triple Exponential (TRIX)

## [Description](./moving_average_triple_exponential_trix.md)
...
## [Syntax](./moving_average_triple_exponential_trix.md)
...
## [Return Value](./moving_average_triple_exponential_trix.md)

**double;** Accessing this method via an index value `[int barsAgo]` returns the indicator value of the referenced bar.

## [Parameters](./moving_average_triple_exponential_trix.md)
...
## [Examples](./moving_average_triple_exponential_trix.md)
...
## [Source Code](./moving_average_triple_exponential_trix.md)
