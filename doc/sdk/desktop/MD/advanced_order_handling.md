**Path**: [Managed Approach](./managed_approach.md) > [Advanced Order Handling](./advanced_order_handling.md)
...
## [Transitioning order references from historical to live](./advanced_order_handling.md)
...
This should be done in [OnOrderUpdate()](./onorderupdate.md) to ensure all cases of order transitions are handled.
...
## [Working with a Multi\-Instrument Strategy](./advanced_order_handling.md)

With advanced order handling, you can submit an order in the context of any [Bars](./bars.md) object by designating the "BarsInProgress" index. For example, if your primary bar series is "MSFT" and your secondary series added to the strategy through the AddDataSeries() method is "AAPL", you can submit an order for either "MSFT" or "AAPL" from anywhere within the strategy. In addition to the information found in the [multi\-time frame and instrument strategies](./multi_time_frame_instruments.md) page, this section specifically covers order submission.
...
## [Examples](./advanced_order_handling.md)
