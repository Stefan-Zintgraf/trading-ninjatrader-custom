**Path**: [Attributes](./attributes.md) > [DisplayAttribute](./displayattribute.md)

# DisplayAttribute

# DisplayAttribute

## [Definition](./displayattribute.md)
...
## [Parameters](./displayattribute.md)
...
A string which sets the tool tip used to describe the property from the UI Note: Expandable properties will NOT display a tool tip (e.g., **[SimpleFont](./simplefont.md)**, **[Stroke](./stroke_class.md)**, or any custom component which are a type of an ExpandableObjectConverter)
