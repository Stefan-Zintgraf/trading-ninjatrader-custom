**Path**: [AddOn Development Overview](./addon_development_overview.md) > [Creating Your Own AddOn Window](./creating_your_own_addon_window.md)

# Creating Your Own AddOn Window

# Creating Your Own AddOn Window

## [The NTWindow Class](./creating_your_own_addon_window.md)
...
## [Using TabControl for Tab Functionality](./creating_your_own_addon_window.md)
...
## [Creating an NTTabPage within an NTWindow](./creating_your_own_addon_window.md)
...
## [Setting Up Workspace Persistence](./creating_your_own_addon_window.md)
...
## [Using XAML to Define Window Layout](./creating_your_own_addon_window.md)
...
## [Using C# to Define Window Layout](./creating_your_own_addon_window.md)
...
## [Launching Your Window From the Control Center](./creating_your_own_addon_window.md)
...
## [Adding NinjaTrader Custom Controls](./creating_your_own_addon_window.md)

User\-interface controls, such as buttons, text fields, and dropdown menus can be defined via XAML (or C#), then behavior and functionality of those controls can be set via C# along with the core logic of your AddOn. In addition to the [standard WPF controls](./controls.md), the NinjaScript AddOn framework provides access to each of the custom NinjaTrader controls that can be found throughout the platform. Below is a list of the most commonly used NinjaTrader controls, along with examples of defining these controls in XAML and adding functionality to them in C#:
...
## [Linking with Other Windows](./creating_your_own_addon_window.md)
