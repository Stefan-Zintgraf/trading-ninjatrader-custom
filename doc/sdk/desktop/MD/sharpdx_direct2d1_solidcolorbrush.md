**Path**: [SharpDX.Direct2D1.SolidColorBrush](./sharpdx_direct2d1_solidcolorbrush.md)
...
## [Definition](./sharpdx_direct2d1_solidcolorbrush.md)
...
*   For convenience, Direct2D provides the [BrushProperties](./sharpdx_direct2d1_brushproperties.md) function for creating a new **SolidColorBrush**.

## [Syntax](./sharpdx_direct2d1_solidcolorbrush.md)
...
*   1.  For NinjaScript Development purposes, you can use the [NinjaTrader.Gui.DxExtensions.ToDxBrush()](./todxbrush.md) helper method to convert a **System.Windows.Media.SolidColorBrush** to a **SharpDX.Direct2D1.SolidColorBrush**.
...
## [Constructors](./sharpdx_direct2d1_solidcolorbrush.md)

Constructor

Description

\`new SolidColorBrush(RenderTarget renderTarget, Color4 color)

Creates a new **SolidColorBrush** that has the specified color and opacity.

new **SolidColorBrush**(RenderTarget renderTarget, Color4 color, Nullable<`brushproperties`\> brushProperties)

Creates a new **SolidColorBrush** that has the specified color and opacity.

## [Methods and Properties](./sharpdx_direct2d1_solidcolorbrush.md)
