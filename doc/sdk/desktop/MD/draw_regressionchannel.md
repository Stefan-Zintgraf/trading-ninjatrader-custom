**Path**: [Draw.RegressionChannel()](./draw_regressionchannel.md)

# Draw.RegressionChannel()

# Draw.RegressionChannel()

## [Definition](./draw_regressionchannel.md)

Draws a regression channel.

## [Method Return Value](./draw_regressionchannel.md)

A **[RegressionChannel](./regressionchannel.md)** object that represents the draw object.

## [Syntax](./draw_regressionchannel.md)
...
## [Parameters](./draw_regressionchannel.md)
...
The line colors ([reference](./brushes.md)).
...
## [Examples](./draw_regressionchannel.md)
