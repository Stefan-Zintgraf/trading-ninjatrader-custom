**Path**: [AddDataSeries()](./adddataseries.md) > [AddPointAndFigure()](./addpointandfigure.md)

# AddPointAndFigure()

# AddPointAndFigure()

## [Definition](./addpointandfigure.md)
...
*   MarketDataType.Ask
*   MarketDataType.Bid
*   MarketDataType.Last Note: Please see the article [here](./using_historical_bid_ask_serie.md) on using Bid/Ask series.
