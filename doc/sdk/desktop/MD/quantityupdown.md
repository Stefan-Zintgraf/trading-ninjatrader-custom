**Path**: [NinjaTrader Controls](./controls.md) > [QuantityUpDown](./quantityupdown.md)

# QuantityUpDown

# QuantityUpDown

## [Definition](./quantityupdown.md)

**QuantityUpDown** can be used as a UI element users can interact with for selecting quantity.

## [Events and Properties](./quantityupdown.md)

Value

An int representing the quantity

## [Examples](./quantityupdown.md)
