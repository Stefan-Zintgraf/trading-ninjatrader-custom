**Path**: [Strategy](./strategy_overview.md) > [Halting a Strategy Once User Defined Conditions Are Met](./halting_a_strategy_once_user_defined_conditions_are_met.md)
...
## [Key concepts in the SampleHaltBasicStrategy example](./halting_a_strategy_once_user_defined_conditions_are_met.md)
...
## [Key concepts in the SampleHaltAdvancedStrategy example](./halting_a_strategy_once_user_defined_conditions_are_met.md)
...
## [Important related documentation](./halting_a_strategy_once_user_defined_conditions_are_met.md)
...
## [Import instructions](./halting_a_strategy_once_user_defined_conditions_are_met.md)
