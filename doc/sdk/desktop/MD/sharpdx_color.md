**Path**: [SharpDX.DisposeBase](./sharpdx_disposebase.md) > [SharpDX.Color](./sharpdx_color.md)
...
## [Syntax](./sharpdx_color.md)

`struct Color`

## [Constructors](./sharpdx_color.md)
...
## [Methods and Properties](./sharpdx_color.md)
...
Converts the color into a [three component](./sharpdx_color3.md) color

**ToColor4()**

Converts the color into a [four component](./sharpdx_color4.md) color

## [Static Named Colors](./sharpdx_color.md)
