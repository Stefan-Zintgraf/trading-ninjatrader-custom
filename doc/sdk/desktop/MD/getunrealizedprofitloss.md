**Path**: [PositionAccount](./positionaccount.md) > [GetUnrealizedProfitLoss()](./getunrealizedprofitloss.md)

# GetUnrealizedProfitLoss()

# GetUnrealizedProfitLoss()

## [Definition](./getunrealizedprofitloss.md)

Calculates the unrealized PnL for the account position.

## [Method Return Value](./getunrealizedprofitloss.md)

A **double** value representing the account's unrealized PnL.

## [Syntax](./getunrealizedprofitloss.md)
...
## [Parameters](./getunrealizedprofitloss.md)
...
## [Examples](./getunrealizedprofitloss.md)
