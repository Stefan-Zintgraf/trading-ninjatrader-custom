**Path**: [Draw.RegionHighlightY()](./draw_regionhighlighty.md) > [RegionHighlightY](./regionhighlighty.md)

# RegionHighlightY

# RegionHighlightY

## [Definition](./regionhighlighty.md)

Represents an interface that exposes information regarding a Region Highlight Y **IDrawingTool**.

## [Methods and Properties](./regionhighlighty.md)
