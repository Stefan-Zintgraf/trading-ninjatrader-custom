**Path**: [Intermediate - RSI with Stop Loss & Profit Target](./intermediate_rsi_with_stop_loss_profit_target.md)
...
This tutorial will cover another approach, using the NinjaScript [Editor](./ninjascript_editor_overview.md) and [New Strategy Wizard](./ninjascript_wizard.md).
...
## [Defining Input Parameters](./intermediate_rsi_with_stop_loss_profit_target.md)
