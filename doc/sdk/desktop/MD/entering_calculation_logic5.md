**Path**: [Advanced - Custom Plot Colors via Thresholds](./advanced_custom_plot_colors.md) > [Entering Calculation Logic](./entering_calculation_logic5.md)
...
## [Setting Plot Thresholds](./entering_calculation_logic5.md)
...
## [Completing the Indicator](./entering_calculation_logic5.md)
