**Path**: [Tips](./tips.md) > [Strategy Position vs. Account Position](./strategy_position_vs_account_position.md)
...
*   Critical: _TD AMERITRADE Users_ When starting a **NinjaScript** strategy, please be absolutely sure your strategy position is in sync with your account position. It is imperative that they are in sync for your **NinjaScript** strategy to run properly.
