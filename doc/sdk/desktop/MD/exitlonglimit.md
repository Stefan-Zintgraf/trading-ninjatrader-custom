**Path**: [Managed Approach](./managed_approach.md) > [ExitLongLimit()](./exitlonglimit.md)

# ExitLongLimit()

# ExitLongLimit()

## [Definition](./exitlonglimit.md)

Generates a sell limit order to exit a long position.

## [Method Return Value](./exitlonglimit.md)
