**Path**: [AddOn Development Overview](./addon_development_overview.md) > [Other Uses for an AddOn](./other_uses_for_an_addon.md)

# Other Uses for an AddOn

# Other Uses for an AddOn

## [Modifying Existing NinjaTrader Windows](./other_uses_for_an_addon.md)
...
## [Accessing Account Data](./other_uses_for_an_addon.md)
...
<`account`\>.[AccountItemUpdate](./accountitemupdate.md)

Triggers on account item updates

<`account`\>.[ExecutionUpdate](./executionupdate.md)

Triggers on any execution

<`account`\>.[OrderUpdate](./orderupdate.md)

Triggers on any order state changes

<`account`\>.[PositionUpdate](./positionupdate.md)
...
## [Accessing Market Data](./other_uses_for_an_addon.md)
