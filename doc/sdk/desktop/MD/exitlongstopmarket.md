**Path**: [Managed Approach](./managed_approach.md) > [ExitLongStopMarket()](./exitlongstopmarket.md)

# ExitLongStopMarket()

# ExitLongStopMarket()

## [Definition](./exitlongstopmarket.md)

Generates a sell stop market order to exit a long position.

## [Method Return Value](./exitlongstopmarket.md)
...
## [Parameters](./exitlongstopmarket.md)
...
## [Examples](./exitlongstopmarket.md)
