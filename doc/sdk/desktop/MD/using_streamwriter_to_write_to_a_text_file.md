**Path**: [Indicator](./indicator_overview.md) > [Using StreamWriter to write to a text file](./using_streamwriter_to_write_to_a_text_file.md)
...
## [Key concepts in this example](./using_streamwriter_to_write_to_a_text_file.md)

*   Creating a text file with StreamWriter
*   Writing Open\-High\-Low\-Close data with date stamps to the file

## [Important related documentation](./using_streamwriter_to_write_to_a_text_file.md)
...
## [Import instructions](./using_streamwriter_to_write_to_a_text_file.md)
