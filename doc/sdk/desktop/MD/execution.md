**Path**: [ATM Strategy Methods](./atm_strategy_methods.md) > [Execution](./execution.md)

# Execution

# Execution

## [Definition](./execution.md)
...
## [Methods and Properties](./execution.md)
...
The position of the execution. Possible values are: _MarketPosition.Long_ _MarketPosition.Short_
