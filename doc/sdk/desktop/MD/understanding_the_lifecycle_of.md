...
![indicator_dialog_state](https://cdn.sanity.io/images/1hlwceal/production/980ffe9a2702c18a6bea0f727864a70ba661e382-636x562.png)
...
![lifetime_of_ninjascript_indicator](https://cdn.sanity.io/images/1hlwceal/production/8c9250f02a22cff3aa2eed20c898298b1cc9c18a-635x562.png)
...
5.  In some extreme scenarios, you may need to execute custom logic before or after an object is cloned. Overriding the default behavior can be done via the virtual [Clone()](./clone.md) method
    

## [What does this mean for me?](./understanding_the_lifecycle_of.md)
...
## [Example](./understanding_the_lifecycle_of.md)
...
## [Cloning NinjaScript](./understanding_the_lifecycle_of.md)
...
## [Saving NinjaScript Properties to the Workspace via XML Serialization](./understanding_the_lifecycle_of.md)
