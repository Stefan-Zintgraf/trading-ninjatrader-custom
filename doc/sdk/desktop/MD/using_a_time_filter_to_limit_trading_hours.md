**Path**: [Strategy](./strategy_overview.md) > [Using a time filter to limit trading hours](./using_a_time_filter_to_limit_trading_hours.md)
...
## [Key concepts in this example](./using_a_time_filter_to_limit_trading_hours.md)

*   Comparing days of the week
*   Comparing the time of day

## [Important related documentation](./using_a_time_filter_to_limit_trading_hours.md)
...
## [Import instructions](./using_a_time_filter_to_limit_trading_hours.md)
