**Path**: [Rendering](./rendering.md) > [OnCalculateMinMax()](./oncalculateminmax.md)

# OnCalculateMinMax()

# OnCalculateMinMax()

## [Definition](./oncalculateminmax.md)
...
## [Method Return Value](./oncalculateminmax.md)

This method does not return a value.

## [Syntax](./oncalculateminmax.md)

You must override the method in your NinjaScript object with the following syntax:

`public override void OnCalculateMinMax()`

## [Method Parameters](./oncalculateminmax.md)

This method does not accept any parameters.

## [Examples](./oncalculateminmax.md)
