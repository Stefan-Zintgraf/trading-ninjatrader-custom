**Path**: [SharpDX.DirectWrite](./sharpdx_directwrite.md) > [SharpDX.DirectWrite.TextLayout.LineMetrics](./sharpdx_directwrite_linemetrics.md)
...
## [Definition](./sharpdx_directwrite_linemetrics.md)

Contains information about a formatted line of text.

(See also [unmanaged API documentation](https://msdn.microsoft.com/en-us/library/dd368099(v=vs.85).aspx))

## [Syntax](./sharpdx_directwrite_linemetrics.md)

`LineMetrics[int idx]`

## [Properties](./sharpdx_directwrite_linemetrics.md)
