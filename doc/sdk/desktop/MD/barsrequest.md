**Path**: [BarsRequest](./barsrequest.md)

# BarsRequest

# BarsRequest

## [Definition](./barsrequest.md)
...
## [Parameters](./barsrequest.md)

Instrument

The [Instrument](./instrument.md) to request
...
## [Methods and Properties](./barsrequest.md)

Bars

The [Bars](./bars.md) object returned from the request
...
A [BarsPeriod](./barsperiod.md) for the bars request
...
A bool representing if the bars request will be [dividend adjusted](https://ninjatrader.com/support/helpGuides/nt8/?splits_and_dividends.htm)

IsResetOnNewTradingDay

A bool representing if the bars request will [Break at EOD](https://ninjatrader.com/support/helpGuides/nt8/NT%20HelpGuide%20English.html?break_at_eod.htm)

IsSplitAdjusted

A bool representing if the bars request will be [split adjusted](https://ninjatrader.com/support/helpGuides/nt8/?splits_and_dividends.htm)

Instrument

The [Instrument](./instrument.md) of the bars request
...
The [merge policy](./mergepolicy.md) for the bars request.
...
The [trading hours](./tradinghours.md) for the bars request
