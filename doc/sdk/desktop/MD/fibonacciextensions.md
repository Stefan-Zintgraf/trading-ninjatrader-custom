**Path**: [Draw.FibonacciExtensions()](./draw_fibonacciextensions.md) > [FibonacciExtensions](./fibonacciextensions.md)

# FibonacciExtensions

# FibonacciExtensions

## [Definition](./fibonacciextensions.md)

Represents an interface that exposes information regarding a Fibonacci Extensions **IDrawingTool**.

## [Methods and Properties](./fibonacciextensions.md)
...
## [Examples](./fibonacciextensions.md)
