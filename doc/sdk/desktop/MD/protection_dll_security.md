**Path**: [Commercial Distribution](./commercial_distribution.md) > [Protection DLL Security](./protection_dll_security.md)
...
At this time we recommend using version [7.0.0.30](https://secureteam.net/content/AgileDotNetInstaller70030.exe)
