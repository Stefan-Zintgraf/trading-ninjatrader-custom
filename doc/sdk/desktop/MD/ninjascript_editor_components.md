**Path**: [Compile Error Codes](./compile_error_codes.md) > [NinjaScript Editor Components](./ninjascript_editor_components.md)

# NinjaScript Editor Components

# NinjaScript Editor Components

## [Overview](./ninjascript_editor_components.md)
...
*   **Tabs** for creating new scripts via the [NinjaScript wizard](./ninjascript_wizard.md) and working on multiple scripts.

![NS_Editor_1](https://cdn.sanity.io/images/1hlwceal/production/b047d453cd5ea2694c69455a297989aed0925212-900x700.png)

## [Context Menus](./ninjascript_editor_components.md)

Context menus can be opened by right\-clicking in the **NinjaScript Editor**.

![NinjaScriptEditorContextMenu](https://cdn.sanity.io/images/1hlwceal/production/430c1688c9c9abf1ea5db392984f2ba7f74e696e-224x487.png)
...
Inserts a code snippet (see [Code Snippets](./code_snippets.md) for more information)
...
Sets if a debug dll should be generated on compilation (see [Visual Studio Debugging](./visual_studio_debugging.md) for more information)
...
Allows printing the content of this window (see [Printing Content](./print.md) for more information)

Share

Allows sharing the content of this window (see [Sharing Content](./share.md) for more information)

Properties

Opens the Properties menu (see below)

## [Properties and Definitions](./ninjascript_editor_components.md)

![ninjatrader_2020-12-03_10-03-00.png](https://cdn.sanity.io/images/1hlwceal/production/80b7663d7d5cb09fde987c679da2de7090a130bb-450x425.png)
