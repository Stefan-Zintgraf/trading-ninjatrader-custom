**Path**: [AddDataSeries()](./adddataseries.md) > [AddKagi()](./addkagi.md)

# AddKagi()

# AddKagi()

## [Definition](./addkagi.md)
...
The underlying BarsType used for the Kagi bars period. Possible values are:
...
An enum determining the mode reversal period is based. Possible values are:
...
Note: Please see the article [here](./using_historical_bid_ask_serie.md) on using Bid/Ask series.
...
A nullable bool determining if the Bars object should [Break at EOD](https://ninjatrader.com/support/helpGuides/nt8/NT%20HelpGuide%20English.html?break_at_eod.htm) Will accept true, false or null as the input. If null is used, the data series will use the settings of the primary data series.
