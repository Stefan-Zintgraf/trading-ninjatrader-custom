**Path**: [Managed Approach](./managed_approach.md) > [ExitShortStopMarket()](./exitshortstopmarket.md)

# ExitShortStopMarket()

# ExitShortStopMarket()

## [Definition](./exitshortstopmarket.md)

Generates a buy to cover stop market order to exit a short position.

## [Method Return Value](./exitshortstopmarket.md)
...
## [Parameters](./exitshortstopmarket.md)
...
## [Examples](./exitshortstopmarket.md)
