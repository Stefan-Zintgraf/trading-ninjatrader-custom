**Path**: [Beginner - Using price variables](./beginner_using_price_variables.md) > [Entering Calculation Logic](./entering_calculation_logic.md)
...
## [Adding the Condition and Assigning the Plot Value](./entering_calculation_logic.md)
