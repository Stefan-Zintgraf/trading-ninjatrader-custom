**Path**: [Intermediate - RSI with Stop Loss & Profit Target](./intermediate_rsi_with_stop_loss_profit_target.md) > [Using Images and Geometry with Custom Icons](./using_images_and_geometry_with_custom_icons.md)

# Using Images and Geometry with Custom Icons

# Using Images and Geometry with Custom Icons

## [Custom Icon Overview](./using_images_and_geometry_with_custom_icons.md)
...
## [Using an Image as an Icon](./using_images_and_geometry_with_custom_icons.md)
...
## [Using Geometry on an Icon](./using_images_and_geometry_with_custom_icons.md)
