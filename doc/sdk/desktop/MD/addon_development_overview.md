**Path**: [AddOn Development Overview](./addon_development_overview.md)

# AddOn Development Overview

# AddOn Development Overview

## [AddOn Development Basics](./addon_development_overview.md)
...
## [NinjaScript Editor Development Environment (NinjaScript Basic)](./addon_development_overview.md)

The NinjaScript Editor can be used to create and write custom AddOns in C#

### Pros

*   Use the familiar [NinjaScript editor](./ninjascript_editor_overview.md) (if you are uncomfortable with Visual Studio)
...
## [AddOn Development Environment (Visual Studio Advanced)](./addon_development_overview.md)
...
## [Creating Your Own AddOn Window](./addon_development_overview.md)
...
![AddOnFrameWorkExample](https://cdn.sanity.io/images/1hlwceal/production/0957b4bb8d7ecf8d013c785592e9651512280533-1061x786.png)

The image above shows a completely new window created by a custom AddOn.

## [Other Uses for an AddOn](./addon_development_overview.md)
...
![AddOnFrameWorkExample3](https://cdn.sanity.io/images/1hlwceal/production/072473fccbbd0000e4f46f9d0519206a0544b574-210x738.png)
