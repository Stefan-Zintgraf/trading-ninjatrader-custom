...
The [stroke](./stroke_class.md) object

width

The width of the stroke

## [Properties](./stroke_class.md)
...
A [SharpDX.Direct2D1.Brush](./sharpdx_direct2d1_brush.md) used to actually render the stroke Note:  To avoid and resolve access violation exceptions, please see Warning and examples remarked below

DashStyleDX

A [SharpDX.Direct2D1.DashStyle](./sharpdx_direct2d1_strokestyle_dashstyle.md) used to render the stroke style Note:  To avoid and resolve access violation exceptions, please see Warning and examples remarked below
...
The [RenderTarget](./rendertarget.md) drawing context used for the stroke.
