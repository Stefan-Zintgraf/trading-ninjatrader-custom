**Path**: [Intermediate - RSI with Stop Loss & Profit Target](./intermediate_rsi_with_stop_loss_profit_target.md) > [Working with Pixel Coordinates](./working_with_pixel_coordinates.md)

# Working with Pixel Coordinates

# Working with Pixel Coordinates

## [Understanding Device Pixels vs. Application Pixels (WPF)](./working_with_pixel_coordinates.md)
...
## [Converting to Device Pixels](./working_with_pixel_coordinates.md)
...
## [Example](./working_with_pixel_coordinates.md)
