**Path**: [Unmanaged Approach](./unmanaged_approach.md) > [SubmitOrderUnmanaged()](./submitorderunmanaged.md)

# SubmitOrderUnmanaged()

# SubmitOrderUnmanaged()

## [Definition](./submitorderunmanaged.md)

Generates an **Unmanaged** order.

## [Method Return Value](./submitorderunmanaged.md)
...
## [Syntax](./submitorderunmanaged.md)
...
## [Parameters](./submitorderunmanaged.md)
...
The index of the Bars object the order is to be submitted against. This determines what instrument the order is submitted for. Note: See the **BarsInProgress** property.

orderAction

Determines if the order is a buy or sell order. Possible values:
...
## [Examples](./submitorderunmanaged.md)
