**Path**: [Unmanaged Approach](./unmanaged_approach.md) > [OrderFillResolutionValue](./orderfillresolutionvalue.md)

# OrderFillResolutionValue

# OrderFillResolutionValue

## [Definition](./orderfillresolutionvalue.md)
...
This property will only be valid if the **OrderFillResolution** is set to [OrderFillResolution.High](./orderfillresolution.md).

## [Property Value](./orderfillresolutionvalue.md)

A int representing the interval used for the bars period during historical order processing. Default value is set to 1.

## [Syntax](./orderfillresolutionvalue.md)
...
## [Examples](./orderfillresolutionvalue.md)
