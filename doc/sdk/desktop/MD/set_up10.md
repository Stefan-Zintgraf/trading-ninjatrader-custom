**Path**: [Beginner - Simple MA Cross Over](./beginner_simple_ma_cross_over.md) > [Set Up](./set_up10.md)
...
## [Setting Default Properties](./set_up10.md)
...
## [Adding Additional Data](./set_up10.md)
...
## [Defining Input Parameters](./set_up10.md)
...
## [Defining Conditions and Actions](./set_up10.md)
...
If you want to proceed with this tutorial through **self programming** [continue here](./creating_the_strategy_via_self_programming.md) after pressing the "Unlock Code" button.

If you want to proceed with this tutorial through **using the Strategy Builder** please [click here](./creating_the_strategy_via_the_wizard.md).
