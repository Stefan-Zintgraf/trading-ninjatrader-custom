**Path**: [OnAccountItemUpdate()](./onaccountitemupdate.md) > [OnOrderUpdate()](./onorderupdate.md)

# OnOrderUpdate()

# OnOrderUpdate()

## [Definition](./onorderupdate.md)
...
## [Playback Connection](./onorderupdate.md)
...
## [Method Return Value](./onorderupdate.md)

This method does not return a value.

## [Syntax](./onorderupdate.md)

You must override the method in your strategy with the following syntax:

**protected override void OnOrderUpdate(Order order, double limitPrice, double stopPrice, int quantity, int filled, double averageFillPrice, OrderState orderState, DateTime time, ErrorCode error, string comment)**

## [Method Parameters](./onorderupdate.md)
...
## [OrderState Values](./onorderupdate.md)
