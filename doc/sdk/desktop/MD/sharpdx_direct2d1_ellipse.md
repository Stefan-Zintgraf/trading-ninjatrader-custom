**Path**: [SharpDX.Direct2D1.Brush](./sharpdx_direct2d1_brush.md) > [SharpDX.Direct2D1.Ellipse](./sharpdx_direct2d1_ellipse.md)
...
## [Definition](./sharpdx_direct2d1_ellipse.md)

Contains the center point, x\-radius, and y\-radius of an ellipse.

(See also [unmanaged API documentation](http://msdn.microsoft.com/en-us/library/dd368097.aspx))

## [Syntax](./sharpdx_direct2d1_ellipse.md)

`struct Ellipse`

## [Constructors](./sharpdx_direct2d1_ellipse.md)
...
## [Properties](./sharpdx_direct2d1_ellipse.md)
