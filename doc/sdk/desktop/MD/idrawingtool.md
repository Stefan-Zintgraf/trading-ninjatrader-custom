**Path**: [Draw.VerticalLine()](./draw_verticalline.md) > [IDrawingTool](./idrawingtool.md)

# IDrawingTool

# IDrawingTool

## [Definition](./idrawingtool.md)
...
For implementing a custom Drawing Tool project, please see the [DrawingTools](./drawing_tools.md) section of this help guide.

## [IDrawingTool Properties](./idrawingtool.md)
...
A read\-only collection of all of the [IDrawingTool](./idrawingtool.md)'s **ChartAnchor**
...
## [ChartAnchor Properties](./idrawingtool.md)
...
An int representing the [CurrentBar](./currentbar.md) value that the **DrawingTool's** chart anchor was drawn
