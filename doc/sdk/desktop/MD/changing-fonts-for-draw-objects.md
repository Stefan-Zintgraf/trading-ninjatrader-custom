**Path**: [Indicator](./indicator_overview.md) > [Changing fonts for draw objects](./changing-fonts-for-draw-objects.md)

# Changing fonts for draw objects

# Changing fonts for draw objects

## [Changing fonts for draw objects](./changing-fonts-for-draw-objects.md)
