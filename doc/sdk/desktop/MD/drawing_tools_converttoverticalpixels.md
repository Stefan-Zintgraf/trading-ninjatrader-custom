**Path**: [ChartAnchor](./chartanchor.md) > [ConvertToVerticalPixels()](./drawing_tools_converttoverticalpixels.md)

# ConvertToVerticalPixels()

# ConvertToVerticalPixels()

## [Definition](./drawing_tools_converttoverticalpixels.md)
...
## [Method Return Value](./drawing_tools_converttoverticalpixels.md)

An **int** value representing the converted value in device pixels.

## [Syntax](./drawing_tools_converttoverticalpixels.md)

`ConvertToVerticalPixels(ChartControl chartControl, ChartPanel chartPanel, double wpfY)`

## [Method Parameters](./drawing_tools_converttoverticalpixels.md)
...
## [Examples](./drawing_tools_converttoverticalpixels.md)
