**Path**: [SharpDX.Direct2D1.GeometrySink](./sharpdx_direct2d1_geometrysink.md) > [SharpDX.Direct2D1.GeometrySink.AddLines()](./sharpdx_direct2d1_geometrysink_addlines.md)
...
## [Definition](./sharpdx_direct2d1_geometrysink_addlines.md)

Creates a sequence of lines using the specified points and adds them to the geometry sink.

(See also [unmanaged API documentation](https://msdn.microsoft.com/en-us/library/dd316925.aspx))

## [Method Return Value](./sharpdx_direct2d1_geometrysink_addlines.md)

This method does not return a value.

## [Syntax](./sharpdx_direct2d1_geometrysink_addlines.md)

`<geometrysink>.AddLines(Vector2[] pointsRef)`

## [Parameters](./sharpdx_direct2d1_geometrysink_addlines.md)
