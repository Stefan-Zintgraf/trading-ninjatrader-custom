**Path**: [Managed Approach](./managed_approach.md) > [ExitShort()](./exitshort.md)

# ExitShort()

# ExitShort()

## [Definition](./exitshort.md)

Generates a buy to cover market order to exit a short position.

## [Method Return Value](./exitshort.md)
