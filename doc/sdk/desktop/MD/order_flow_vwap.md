**Path**: [System Indicator Methods](./system_indicator_methods.md) > [Order Flow VWAP](./order_flow_vwap.md)

# Order Flow VWAP

# Order Flow VWAP

## [Description](./order_flow_vwap.md)
...
## [Return Value](./order_flow_vwap.md)

**double;** Accessing this method via an index value \[int barsAgo\] returns the indicator value of the referenced bar.

## [Parameters](./order_flow_vwap.md)
