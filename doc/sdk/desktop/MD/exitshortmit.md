**Path**: [Managed Approach](./managed_approach.md) > [ExitShortMIT()](./exitshortmit.md)

# ExitShortMIT()

# ExitShortMIT()

## [Definition](./exitshortmit.md)

Generates a buy to cover MIT order to exit a short position.

## [Method Return Value](./exitshortmit.md)
...
## [Tips (also see](./exitshortmit.md) [Overview](./managed_approach.md))
