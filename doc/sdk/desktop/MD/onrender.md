**Path**: [Rendering](./rendering.md) > [OnRender()](./onrender.md)

# OnRender()

# OnRender()

## [Definition](./onrender.md)
...
1.  This method uses the 3rd party SharpDX library to render custom Direct2D Text and Shapes. For a walk through for using the SharpDX, please see the educational resource [Using SharpDX for Custom Chart Rendering](./using_sharpdx_for_custom_chart_rendering.md).
...
## [Method Return Value](./onrender.md)
...
Please see the help guide topic on [Working with Brushes](./working_with_brushes.md) for general information on using brushes and advanced brush concepts. If you are using standard **Plots** along with custom rendering from an indicator or strategy, you will need to ensure to call the **base.OnRender()** method for those plots to display.

## [Examples](./onrender.md)
