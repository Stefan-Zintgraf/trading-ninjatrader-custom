**Path**: [Intermediate - Historical Custom Series](./intermediate_historical_custom_series.md) > [Entering Calculation Logic](./entering_calculation_logic4.md)
...
## [Creating the Series`<double>` Object](./entering_calculation_logic4.md)
...
*   [Creating the Series](./entering_calculation_logic4.md)