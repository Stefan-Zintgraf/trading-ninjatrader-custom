**Path**: [Attributes](./attributes.md) > [TypeConverterAttribute()](./typeconverterattribute.md)

# TypeConverterAttribute()

# TypeConverterAttribute()

## [Definition](./typeconverterattribute.md)
...
*   If you are looking to extend behavior of an Indicator or Strategy (e.g., values of one property influence another), you must implement either an [IndicatorBaseTypeConverter](./indicatorbaseconverter.md) or [StrategyBaseTypeConveter](./strategybaseconverter.md).  This is to ensure default property descriptor behavior works as intended.
...
## [Syntax](./typeconverterattribute.md)

`TypeConverterAttribute(string)`

`TypeConverterAttribute(type)`

## [Examples](./typeconverterattribute.md)
