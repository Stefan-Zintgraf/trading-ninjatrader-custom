**Path**: [Managed Approach](./managed_approach.md) > [ExitLongStopLimit()](./exitlongstoplimit.md)

# ExitLongStopLimit()

# ExitLongStopLimit()

## [Definition](./exitlongstoplimit.md)

Generates a sell stop limit order to exit a long position.

## [Method Return Value](./exitlongstoplimit.md)
...
## [Parameters](./exitlongstoplimit.md)
