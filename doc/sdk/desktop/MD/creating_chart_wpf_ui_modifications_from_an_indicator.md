**Path**: [Indicator](./indicator_overview.md) > [Creating Chart WPF (UI) Modifications from an Indicator](./creating_chart_wpf_ui_modifications_from_an_indicator.md)
...
## [Key concepts in this example](./creating_chart_wpf_ui_modifications_from_an_indicator.md)
...
## [Important related documentation](./creating_chart_wpf_ui_modifications_from_an_indicator.md)
...
## [Import instructions](./creating_chart_wpf_ui_modifications_from_an_indicator.md)
