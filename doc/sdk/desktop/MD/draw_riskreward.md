**Path**: [Draw.RiskReward()](./draw_riskreward.md)

# Draw.RiskReward()

# Draw.RiskReward()

## [Definition](./draw_riskreward.md)

Draws a risk/reward on a chart.

## [Method Return Value](./draw_riskreward.md)

A **[RiskReward](./riskreward.md)** object that represents the draw object.

## [Syntax](./draw_riskreward.md)
