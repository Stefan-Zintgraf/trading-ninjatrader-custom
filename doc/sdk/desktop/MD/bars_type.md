...
## [Methods and Properties](./bars_type.md)
...
Determines if the bars type can use the [RemoveLastBar()](./removelastbar.md) method when true, otherwise an exception will be thrown.

[IsTimebased](./istimebased.md)

Used to indicate the BarsType is built from time\-based bars (day, minute, second).

[OnDataPoint()](./ondatapoint.md)

OnDataPoint() method is where you should adjust data points (bar values) of your series through [AddBar()](./addbar.md) and [UpdateBar()](./updatebar.md).
