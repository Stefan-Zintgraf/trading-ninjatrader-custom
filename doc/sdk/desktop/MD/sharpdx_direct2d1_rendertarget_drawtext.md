**Path**: [SharpDX.Direct2D1.RenderTarget](./sharpdx_direct2d1_rendertarget.md) > [SharpDX.Direct2D1.RenderTarget.DrawText()](./sharpdx_direct2d1_rendertarget_drawtext.md)
...
## [Definition](./sharpdx_direct2d1_rendertarget_drawtext.md)
...
## [Method Return Value](./sharpdx_direct2d1_rendertarget_drawtext.md)

This method does not return a value.

## [Syntax](./sharpdx_direct2d1_rendertarget_drawtext.md)
...
A **SharpDX.Direct2D1.MeasuringMode** value that indicates how glyph metrics are used to measure text when it is formatted. The default value is **DWRITE\_MEASURING\_MODE\_NATURAL**.
