...
[Alert, Debug, Share](./alert_and_debug_concepts.md)
...
Documents the drawing of custom shapes, lines, text and colors on your price and indicator panels from both [Indicators](./indicator.md) and [Strategies](./strategy.md)

[Instrument](./instrument.md)

Represents an instance of a [Master Instrument](./masterinstrument.md)
