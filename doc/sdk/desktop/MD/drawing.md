**Path**: [Drawing](./drawing.md)

# Drawing

# Drawing

You can use **NinjaScript** to draw custom shapes, lines, text and colors on price and indicator panels from both [Indicators](./indicators.md) and [Strategies](./strategies.md).

## [Draw Methods and Associated Return Types](./drawing.md)
...
[Draw.HorizontalLine()](./draw_horizontal_line.md)
...
## [Drawing Methods and Properties](./drawing.md)
...
[SimpleFont Class](./simplefont.md)
