**Path**: [Draw.PathTool()](./draw_pathtool.md)

# Draw.PathTool()

# Draw.PathTool()

## [Definition](./draw_pathtool.md)

Draws a path which can have a user defined set of anchors.

## [Method Return Value](./draw_pathtool.md)

A **[PathTool](./pathtool.md)** object that represents the draw object.

## [Syntax](./draw_pathtool.md)
