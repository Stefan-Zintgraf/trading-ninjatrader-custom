**Path**: [Analytical](./analytical.md) > [GetCurrentBid()](./getcurrentbid.md)

# GetCurrentBid()

# GetCurrentBid()

## [Definition](./getcurrentbid.md)
...
1.  When accessed during **State.Historical**, the [Close](./close.md) price of the evaluated bar is substituted. To access historical bid prices, please see [Developing for Tick Replay](./developing_for_tick_replay.md).
...
## [Method Return Value](./getcurrentbid.md)

A **double** value representing the current bid price.

## [Syntax](./getcurrentbid.md)

`GetCurrentBid()`

`GetCurrentBid(int barsSeriesIndex)`

## [Parameters](./getcurrentbid.md)
