**Path**: [SharpDX.DirectWrite](./sharpdx_directwrite.md) > [SharpDX.DirectWrite.TextFormat.ReadingDirection](./sharpdx_directwrite_textformat_readingdirection.md)
...
## [Definition](./sharpdx_directwrite_textformat_readingdirection.md)
...
## [Property Value](./sharpdx_directwrite_textformat_readingdirection.md)

A **SharpDX.DirectWrite.ReadingDirection** enum value that indicates the current reading direction for text in a paragraph.

## [Possible values are](./sharpdx_directwrite_textformat_readingdirection.md)
...
## [Syntax](./sharpdx_directwrite_textformat_readingdirection.md)
