**Path**: [Intermediate - RSI with Stop Loss & Profit Target](./intermediate_rsi_with_stop_loss_profit_target.md) > [Multi-Time Frame & Instruments](./multi_time_frame_instruments.md)

# Multi-Time Frame & Instruments

# Multi\-Time Frame & Instruments

## [Multi\-Series Scripting Overview](./multi_time_frame_instruments.md)
...
## [Data processing sequence](./multi_time_frame_instruments.md)
...
## [Shared Timestamps](./multi_time_frame_instruments.md)
...
![same_timestamp_bars](https://cdn.sanity.io/images/1hlwceal/production/a2e45dcebc1d6aefcfbf8bb94fba4159d1b2e580-1111x310.png)

## [Adding Additional Bars Objects to NinjaScript](./multi_time_frame_instruments.md)
...
*   This method should ONLY be called from the [OnStateChange()](./onstatechange.md) method during State.Configure.
*   Arguments supplied to **AddDataSeries()** should be hardcoded and NOT dependent on run\-time variables which cannot be reliably obtained during [State.Configure](./state.md) (e.g., [Instrument](./instrument.md), [Bars](./bars.md), or user input). Attempting to add a data series dynamically is NOT guaranteed and therefore should be avoided. Trying to load bars dynamically may result in an error similar to: Unable to load bars series. Your NinjaScript may be trying to use an additional data series dynamically in an unsupported manner.
*   When instantiating indicators in a Multi\-Series script in [OnStateChange](./onstatechange.md), the input any hosted indicator is running on should be explicitly stated (since a specific [BarsInProgress](./barsinprogress.md) is not guaranteed).
...
## [How Bars Data is Referenced](./multi_time_frame_instruments.md)
...
![Tips_3](https://cdn.sanity.io/images/1hlwceal/production/25d309fa9e3eabca5ecd2cc88788c3ac5d7dae3c-287x184.png)
...
![Tips_4](https://cdn.sanity.io/images/1hlwceal/production/85504ae88b21be41de7ffa274752499b3c23c387-287x184.png)
...
## [Using Bars Objects as Input to Indicator Methods](./multi_time_frame_instruments.md)
...
## [True Event Driven OnBarUpdate() Method](./multi_time_frame_instruments.md)
...
## [Accessing the Price Data in a Multi\-Bars NinjaScript](./multi_time_frame_instruments.md)
...
## [Entering, Exiting and Retrieving Position Information](./multi_time_frame_instruments.md)
