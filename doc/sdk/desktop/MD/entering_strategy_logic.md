**Path**: [Intermediate - RSI with Stop Loss & Profit Target](./intermediate_rsi_with_stop_loss_profit_target.md) > [Entering Strategy Logic](./entering_strategy_logic.md)

# Entering Strategy Logic

# Entering Strategy Logic

## [Using the **OnStateChange()** Method to Configure the Strategy](./entering_strategy_logic.md)
...
## [Using the **OnBarUpdate()** Method for the Core Strategy Logic](./entering_strategy_logic.md)
...
*   [Using the](./entering_strategy_logic.md)
*   [Using the](./entering_strategy_logic.md)