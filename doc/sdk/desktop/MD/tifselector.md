**Path**: [NinjaTrader Controls](./controls.md) > [TifSelector](./tifselector.md)

# TifSelector

# TifSelector

## [Definition](./tifselector.md)

**TifSelector** can be used as a UI element users can interact with for selecting TIF.

## [Events and Properties](./tifselector.md)
...
Disposes of the **TifSelector** (Note: calling the [NTTabPage base.Cleanup()](./cleanup.md) is sufficient to clean up this control)

**SelectedTif**

A **TimeInForce** representing the selected TIF
