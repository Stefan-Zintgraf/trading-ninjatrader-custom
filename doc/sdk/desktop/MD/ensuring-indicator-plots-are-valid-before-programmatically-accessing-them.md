**Path**: [Indicator](./indicator_overview.md) > [Ensuring indicator plots are valid before programmatically accessing them](./ensuring-indicator-plots-are-valid-before-programmatically-accessing-them.md)
...
## [Key concepts in this example](./ensuring-indicator-plots-are-valid-before-programmatically-accessing-them.md)

*   Checking indicator plots for valid values
*   Handling logic for when the indicator plots are not valid

## [Attached archive contains two indicator files](./ensuring-indicator-plots-are-valid-before-programmatically-accessing-them.md)
...
## [Important related documentation](./ensuring-indicator-plots-are-valid-before-programmatically-accessing-them.md)

*   [IsValidDataPoint()](./isvaliddatapoint.md)
*   [Series](./seriest.md)

## [Import instructions](./ensuring-indicator-plots-are-valid-before-programmatically-accessing-them.md)
