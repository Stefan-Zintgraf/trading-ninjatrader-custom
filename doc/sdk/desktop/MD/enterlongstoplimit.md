**Path**: [Managed Approach](./managed_approach.md) > [EnterLongStopLimit()](./enterlongstoplimit.md)

# EnterLongStopLimit()

# EnterLongStopLimit()

## [Definition](./enterlongstoplimit.md)

Generates a buy stop limit order to enter a long position.

## [Method Return Value](./enterlongstoplimit.md)
...
## [Parameters](./enterlongstoplimit.md)
...
## [Examples](./enterlongstoplimit.md)
