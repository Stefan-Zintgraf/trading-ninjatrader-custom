**Path**: [Managed Approach](./managed_approach.md) > [ExitLong()](./exitlong.md)

# ExitLong()

# ExitLong()

## [Definition](./exitlong.md)

Generates a sell market order to exit a long position.

## [Method Return Value](./exitlong.md)
...
## [Tips (also see](./exitlong.md) [Overview](./managed_approach.md))
