**Path**: [Trading Hours](./tradinghours.md) > [TriggerCustomEvent()](./triggercustomevent.md)

# TriggerCustomEvent()

# TriggerCustomEvent()

## [Definition](./triggercustomevent.md)
...
## [Method Return Value](./triggercustomevent.md)

This method does not have a return value.

## [Syntax](./triggercustomevent.md)
...
## [Parameters](./triggercustomevent.md)
...
Index of the [bar series](./barsinprogress.md) you want to synchronize to
...
## [Examples](./triggercustomevent.md)
