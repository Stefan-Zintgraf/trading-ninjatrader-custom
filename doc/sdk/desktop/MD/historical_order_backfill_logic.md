**Path**: [Intermediate - RSI with Stop Loss & Profit Target](./intermediate_rsi_with_stop_loss_profit_target.md) > [Historical Order Backfill Logic](./historical_order_backfill_logic.md)

# Historical Order Backfill Logic

# Historical Order Backfill Logic

## [Understanding How Orders are backfilled for **NinjaScript** strategies](./historical_order_backfill_logic.md)
...
## [General Outline](./historical_order_backfill_logic.md)
...
## [Step 1 \- Prepare to Calculate Fill Prices](./historical_order_backfill_logic.md)
...
## [Step 2 \- Take Three Passes To Determine Fill Price](./historical_order_backfill_logic.md)
...
## [Step 3 \- Fill the Order](./historical_order_backfill_logic.md)
...
*   [Understanding How Orders are backfilled for](./historical_order_backfill_logic.md)
*   [General Outline](./historical_order_backfill_logic.md)
*   [Step 1 \- Prepare to Calculate Fill Prices](./historical_order_backfill_logic.md)
*   [Step 2 \- Take Three Passes To Determine Fill Price](./historical_order_backfill_logic.md)
*   [Step 3 \- Fill the Order](./historical_order_backfill_logic.md)