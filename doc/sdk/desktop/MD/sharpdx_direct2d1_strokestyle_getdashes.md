**Path**: [SharpDX.Direct2D1.StrokeStyle](./sharpdx_direct2d1_strokestyle.md) > [SharpDX.Direct2D1.StrokeStyle.GetDashes()](./sharpdx_direct2d1_strokestyle_getdashes.md)
...
## [Definition](./sharpdx_direct2d1_strokestyle_getdashes.md)
...
## [Method return value](./sharpdx_direct2d1_strokestyle_getdashes.md)

This method does not return a value.

## [Syntax](./sharpdx_direct2d1_strokestyle_getdashes.md)

`<strokestyle>.GetDashes(float[] dashes, int dashesCount)`

## [Parameters](./sharpdx_direct2d1_strokestyle_getdashes.md)
