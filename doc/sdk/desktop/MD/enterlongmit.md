**Path**: [Managed Approach](./managed_approach.md) > [EnterLongMIT()](./enterlongmit.md)

# EnterLongMIT()

# EnterLongMIT()

## [Definition](./enterlongmit.md)

Generates a buy MIT order to enter a long position.

## [Method Return Value](./enterlongmit.md)
