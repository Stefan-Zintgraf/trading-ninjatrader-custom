**Path**: [Intermediate - RSI with Stop Loss & Profit Target](./intermediate_rsi_with_stop_loss_profit_target.md) > [Multi-Threading Consideration for NinjaScript](./multi_threading_consideration_for_ninjascript.md)

# Multi-Threading Consideration for NinjaScript

# Multi\-Threading Consideration for NinjaScript

## [Multi\-Threading Overview](./multi_threading_consideration_for_ninjascript.md)
...
## [Using A Dispatcher](./multi_threading_consideration_for_ninjascript.md)
...
## [Thread Access](./multi_threading_consideration_for_ninjascript.md)
...
## [Cross Thread Exceptions](./multi_threading_consideration_for_ninjascript.md)
...
## [Access Violation Exception](./multi_threading_consideration_for_ninjascript.md)
...
## [Multi\-threaded consideration for Order, Execution and Position objects](./multi_threading_consideration_for_ninjascript.md)

These considerations apply to the [OnOrderUpdate()](./onorderupdate.md), [OnExecutionUpdate()](./onexecutionupdate.md) and [OnPositionUpdate()](./onpositionupdate.md) handlers, where both the actual 'core' objects are passed by reference and updating method value parameters are provided. Exemplary the [OnOrderUpdate()](./onorderupdate.md) is discussed in below.
