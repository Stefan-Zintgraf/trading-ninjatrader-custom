**Path**: [Managed Approach](./managed_approach.md) > [ExitShortStopLimit()](./exitshortstoplimit.md)

# ExitShortStopLimit()

# ExitShortStopLimit()

## [Definition](./exitshortstoplimit.md)

Generates a buy to cover stop limit order to exit a short position.

## [Method Return Value](./exitshortstoplimit.md)
...
## [Parameters](./exitshortstoplimit.md)
...
## [Examples](./exitshortstoplimit.md)
...
## [Tips (also see](./exitshortstoplimit.md) [Overview](./managed_approach.md))
...
*   [Parameters](./exitshortstoplimit.md)
*   [Examples](./exitshortstoplimit.md)
*   [Tips (also see](./exitshortstoplimit.md)