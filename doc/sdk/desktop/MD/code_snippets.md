**Path**: [Compile Error Codes](./compile_error_codes.md) > [Code Snippets](./code_snippets.md)
...
## [Understanding Code Snippet shortcuts](./code_snippets.md)
...
## [How to insert Code Snippets via the mouse or F2 key](./code_snippets.md)
...
Right mouse click in the NinjaScript Editor and select the menu name "Insert Code Snippet"

![NS_Editor_10](https://cdn.sanity.io/images/1hlwceal/production/b843922753198d05714b60cad36f31627582a85f-226x170.png)

A menu will display all available code snippets.

![NS_Editor_11](https://cdn.sanity.io/images/1hlwceal/production/6ee5aa8d3aa03cbfeb9ec2e2c369f2ee67b6a15a-668x390.png)
