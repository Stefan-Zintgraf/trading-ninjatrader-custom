**Path**: [NinjaTrader Controls](./controls.md) > [AtmStrategySelector](./atmstrategyselector.md)

# AtmStrategySelector

# AtmStrategySelector

## [Definition](./atmstrategyselector.md)

AtmStrategySelector is an UI element users can interact with for selecting ATM Strategies.

## [Events and Properties](./atmstrategyselector.md)
...
## [Examples](./atmstrategyselector.md)
