**Path**: [Draw.Region()](./draw_region.md)

# Draw.Region()

# Draw.Region()

## [Definition](./draw_region.md)

Draws a region on a chart.

## [Method Return Value](./draw_region.md)

A **[Region](./region.md)** object that represents the draw object.

## [Syntax](./draw_region.md)
...
An optional parameter which will offset the barsAgo value for the **Series<`double`\>** value used to match the desired [Displacement](./displacement.md). Default value is 0.

## [Examples](./draw_region.md)
