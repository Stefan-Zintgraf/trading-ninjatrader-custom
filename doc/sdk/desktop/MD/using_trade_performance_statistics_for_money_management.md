**Path**: [Strategy](./strategy_overview.md) > [Using trade performance statistics for money management](./using_trade_performance_statistics_for_money_management.md)
...
## [Key concepts in this example](./using_trade_performance_statistics_for_money_management.md)
...
## [Important related documentation](./using_trade_performance_statistics_for_money_management.md)

*   [SystemPerformance](./systemperformance.md)
*   [TradeCollection](./tradecollection.md)
*   [AllTrades\*](./alltrades.md)

_\* This reference sample uses the **.AllTrades** property. This property will include all historical virtual trades as well as real\-time trades. If you wish to only make calculations based on real\-time trades you can use the **.RealtimeTrades** property._

## [Import instructions](./using_trade_performance_statistics_for_money_management.md)
