...
## [Methods and Properties](./order.md)
...
The [Account](./account_class.md) the order resides
...
A bool value representing if the order is an overfill. For use when using [Unmanaged orders](./unmanaged_approach.md) and [IgnoreOverFill](./ignoreoverfill.md)

Instrument

An [Instrument](./instrument.md) value representing the instrument of an order

IsBacktestOrder

A bool that indicates if the order was generated while processing historical data. For use with [GetRealtimeOrder()](./getrealtimeorder.md) when transitioning historical order objects to live order objects when strategies transition to from State.Historical to State.Realtime.
...
A double value representing the new limit price of an order. Used with [Account.Change()](./change.md)
...
An int value representing the new quantity of an order. Used with [Account.Change()](./change.md)
...
A double value representing the new stop price of an order. Used with [Account.Change()](./change.md)
